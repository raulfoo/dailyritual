...
ensure_file("config/system_config_files/nginx.dailyritual.conf", "/etc/nginx/sites-enabled/dailyritual.conf") do
...
dep "create dailyritual database user" do
